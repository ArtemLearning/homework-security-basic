...
@RowLevelRole(name = "Editing employees of own department", code = "edit-own-department")
public interface EditDepartmentEmployees {

    @PredicateRowLevelPolicy(entityClass = Employee.class,
            actions = {
                    RowLevelPolicyAction.CREATE,
                    RowLevelPolicyAction.UPDATE,
                    RowLevelPolicyAction.DELETE
            })

    default RowLevelBiPredicate<Employee, ApplicationContext> allowEditOwnDepartmentUsers() {
